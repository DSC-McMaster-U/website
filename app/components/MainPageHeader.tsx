                            ...
                            {navLinks.map((navLink, index) => (
                                <li key={index} className="relative cursor-default group text-black-00 dark:text-white-00">
                                    {navLink.links ? (
                                        ...
                                        <Link href={navLink.href} className="flex items-center transition-colors duration-200 py-1 px-3 hover:text-grey-700 cursor-pointer bg-black-03 rounded-2xl mr-4">
                                            {navLink.name}
                                        </Link>
